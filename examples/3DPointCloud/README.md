...
````
2. Copy ***DlibDotNet.dll***, ***DlibDotNet.Native.dll*** and ***DlibDotNet.Native.Dnn.dll*** to output directory; &lt;3DPointCloud_dir&gt;\bin\Release\netcoreapp2.0.
...
![All](images/3dpointcloud.gif "All")