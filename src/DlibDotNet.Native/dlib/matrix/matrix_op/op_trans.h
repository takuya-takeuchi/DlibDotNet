...
#define matrix_op_op_trans_delete_template(__TYPE__, error, __ELEMENT_TYPE__, __ROWS__, __COLUMNS__, ...) \
auto mat = static_cast<matrix_op<op_trans<matrix<__TYPE__, __ROWS__, __COLUMNS__>>>*>(obj);\
delete mat;\

#define matrix_op_op_trans_nc_template(__TYPE__, error, __ELEMENT_TYPE__, __ROWS__, __COLUMNS__, ...) \
auto mat = static_cast<matrix_op<op_trans<matrix<__TYPE__, __ROWS__, __COLUMNS__>>>*>(obj);\
*ret = mat->nc();\

#define matrix_op_op_trans_nr_template(__TYPE__, error, __ELEMENT_TYPE__, __ROWS__, __COLUMNS__, ...) \
auto mat = static_cast<matrix_op<op_trans<matrix<__TYPE__, __ROWS__, __COLUMNS__>>>*>(obj);\
*ret = mat->nr();\

#define matrix_op_op_trans_operator_left_shift_template(__TYPE__, error, __ELEMENT_TYPE__, __ROWS__, __COLUMNS__, ...) \
auto& mat = *(static_cast<matrix_op<op_trans<matrix<__TYPE__, __ROWS__, __COLUMNS__>>>*>(obj));\
*stream << mat;\
...
DLLEXPORT void matrix_op_op_trans_delete(matrix_element_type type, void* obj, const int templateRows, const int templateColumns)
{
    ...
    matrix_template(type,
                    ...
                    matrix_op_op_trans_delete_template,
                    templateRows,
                    templateColumns,
                    obj);
}
...
DLLEXPORT int matrix_op_op_trans_nc(matrix_element_type type, void* obj, const int templateRows, const int templateColumns, int* ret)
{
    ...
    matrix_template(type,
                    error,
                    matrix_template_size_template,
                    matrix_op_op_trans_nc_template,
                    templateRows,
                    templateColumns,
                    obj,
                    ret);
...
DLLEXPORT int matrix_op_op_trans_nr(matrix_element_type type, void* obj, const int templateRows, const int templateColumns, int* ret)
{
    ...
    matrix_template(type,
                    error,
                    matrix_template_size_template,
                    matrix_op_op_trans_nr_template,
                    templateRows,
                    templateColumns,
                    obj,
                    ret);
...
DLLEXPORT int matrix_op_op_trans_operator_left_shift(matrix_element_type type, void* obj, const int templateRows, const int templateColumns, std::ostringstream* stream)
{
    ...
    matrix_numeric_template(type,
                            error,
                            matrix_template_size_template,
                            matrix_op_op_trans_operator_left_shift_template,
                            templateRows,
                            templateColumns,
                            obj,
                            stream);
