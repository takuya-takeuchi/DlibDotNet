...
#define save_png_matrix_template_sub(__TYPE__, __ROWS__, __COLUMNS__, error, matrix, file_name) \
...
#define save_png_matrix_template(__TYPE__, __ROWS__, __COLUMNS__, error, matrix, file_name) \
do {\
    matrix_template_size_arg2_template(__TYPE__, __ROWS__, __COLUMNS__, save_png_matrix_template_sub, error, matrix, file_name);\
} while (0)
...
DLLEXPORT int save_png_matrix(matrix_element_type type, void* matrix, const int templateRows, const int templateColumns, const char* file_name)
{
    ...
    switch(type)
    {
        case matrix_element_type::UInt8:
            save_png_matrix_template(uint8_t, templateRows, templateColumns, err, matrix, file_name);
            break;
        case matrix_element_type::UInt16:
            save_png_matrix_template(uint16_t, templateRows, templateColumns, err, matrix, file_name);
            break;
        ...
        case matrix_element_type::Int16:
            save_png_matrix_template(int16_t, templateRows, templateColumns, err, matrix, file_name);
            break;
        ...
        case matrix_element_type::Double:
            save_png_matrix_template(double, templateRows, templateColumns, err, matrix, file_name);
            break;
        case matrix_element_type::RgbPixel:
            save_png_matrix_template(rgb_pixel, templateRows, templateColumns, err, matrix, file_name);
            break;
        case matrix_element_type::HsiPixel:
            save_png_matrix_template(hsi_pixel, templateRows, templateColumns, err, matrix, file_name);
            break;
        case matrix_element_type::RgbAlphaPixel:
            save_png_matrix_template(rgb_alpha_pixel, templateRows, templateColumns, err, matrix, file_name);
            break;
        default:
