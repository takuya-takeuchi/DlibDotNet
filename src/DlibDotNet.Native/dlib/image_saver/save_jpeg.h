...
DLLEXPORT int save_jpeg_matrix(matrix_element_type type, void* matrix, const int templateRows, const int templateColumns, const char* file_name, int quality)
{
    ...
    switch(type)
    {
        ...
        case matrix_element_type::UInt64:
            save_jpeg_matrix_template(uint64_t, templateRows, templateColumns, err, matrix, file_name, quality);
            break;
        ...
        case matrix_element_type::Int64:
            save_jpeg_matrix_template(int64_t, templateRows, templateColumns, err, matrix, file_name, quality);
            break;
