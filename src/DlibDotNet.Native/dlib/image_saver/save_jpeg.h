...
#define save_jpeg_matrix_template(ELEMENT) \
do {\
...
DLLEXPORT int save_jpeg_matrix(matrix_element_type type, void* matrix, const int templateRows, const int templateColumns, const char* file_name, int quality)
{
    ...
    switch(type)
    {
        case matrix_element_type::UInt8:
            save_jpeg_matrix_template(uint8_t);
            break;
        case matrix_element_type::UInt16:
            save_jpeg_matrix_template(uint16_t);
            break;
        case matrix_element_type::UInt32:
            save_jpeg_matrix_template(uint32_t);
            break;
        case matrix_element_type::Int8:
            save_jpeg_matrix_template(int8_t);
            break;
        case matrix_element_type::Int16:
            save_jpeg_matrix_template(int16_t);
            break;
        case matrix_element_type::Int32:
            save_jpeg_matrix_template(int32_t);
            break;
        case matrix_element_type::Float:
            save_jpeg_matrix_template(float);
            break;
        case matrix_element_type::Double:
            save_jpeg_matrix_template(double);
            break;
        case matrix_element_type::RgbPixel:
            save_jpeg_matrix_template(rgb_pixel);
            break;
        case matrix_element_type::HsiPixel:
            save_jpeg_matrix_template(hsi_pixel);
            break;
