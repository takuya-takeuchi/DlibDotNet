...
DLLEXPORT int load_jpeg(array2d_type type, void* image, const char* file_name)
{
    int err = ERR_OK;
    switch(type)
    {
        ...
        case array2d_type::UInt32:
            dlib::load_jpeg(*((array2d<uint32_t>*)image), file_name);
            break;
        case array2d_type::Int8:
            dlib::load_jpeg(*((array2d<int8_t>*)image), file_name);
            break;
        case array2d_type::Int16:
            dlib::load_jpeg(*((array2d<int16_t>*)image), file_name);
            break;
        case array2d_type::Int32:
            dlib::load_jpeg(*((array2d<int32_t>*)image), file_name);
            break;
