...
DLLEXPORT void* LossMmod_trainer_new2(const int id, void* net, const ::optimizer_type optimizer_id, void* optimizer)
{
    auto iter = LossMmodRegistry.find(id);
    if (iter == end(LossMmodRegistry))
        return nullptr;
...
DLLEXPORT void LossMmod_trainer_delete(const int id, void* trainer, const ::optimizer_type optimizer_id)
{
    auto iter = LossMmodRegistry.find(id);
    if (iter == end(LossMmodRegistry))
        return;
...
DLLEXPORT int LossMmod_trainer_set_learning_rate(const int id, void* trainer, const ::optimizer_type optimizer_id, const double lr)
{
    auto iter = LossMmodRegistry.find(id);
    if (iter == end(LossMmodRegistry))
        return ERR_DNN_NOT_SUPPORT_NETWORKTYPE;
...
DLLEXPORT int LossMmod_trainer_get_learning_rate(const int id, void* trainer, const ::optimizer_type optimizer_id, double* lr)
{
    auto iter = LossMmodRegistry.find(id);
    if (iter == end(LossMmodRegistry))
        return ERR_DNN_NOT_SUPPORT_NETWORKTYPE;
...
DLLEXPORT int LossMmod_trainer_get_average_loss(const int id, void* trainer, const ::optimizer_type optimizer_id, double* loss)
{
    auto iter = LossMmodRegistry.find(id);
    if (iter == end(LossMmodRegistry))
        return ERR_DNN_NOT_SUPPORT_NETWORKTYPE;
...
DLLEXPORT int LossMmod_trainer_get_average_test_loss(const int id, void* trainer, const ::optimizer_type optimizer_id, double* loss)
{
    auto iter = LossMmodRegistry.find(id);
    if (iter == end(LossMmodRegistry))
        return ERR_DNN_NOT_SUPPORT_NETWORKTYPE;
...
DLLEXPORT int LossMmod_trainer_set_min_learning_rate(const int id, void* trainer, const ::optimizer_type optimizer_id, const double lr)
{
    auto iter = LossMmodRegistry.find(id);
    if (iter == end(LossMmodRegistry))
        return ERR_DNN_NOT_SUPPORT_NETWORKTYPE;
...
DLLEXPORT int LossMmod_trainer_set_mini_batch_size(const int id, void* trainer, const ::optimizer_type optimizer_id, const unsigned long size)
{
    auto iter = LossMmodRegistry.find(id);
    if (iter == end(LossMmodRegistry))
        return ERR_DNN_NOT_SUPPORT_NETWORKTYPE;
...
DLLEXPORT int LossMmod_trainer_be_verbose(const int id, void* trainer, const ::optimizer_type optimizer_id)
{
    auto iter = LossMmodRegistry.find(id);
    if (iter == end(LossMmodRegistry))
        return ERR_DNN_NOT_SUPPORT_NETWORKTYPE;
