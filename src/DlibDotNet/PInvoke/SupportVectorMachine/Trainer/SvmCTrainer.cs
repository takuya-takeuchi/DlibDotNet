...
namespace DlibDotNet
{
    ...
    internal sealed partial class NativeMethods
    {
        ...
        [DllImport(NativeLibrary, CallingConvention = CallingConvention)]
        public static extern ErrorType svm_c_trainer_new2(SvmKernelType kernelType,
                                                          MatrixElementType type,
                                                          IntPtr kernel,
                                                          float c,
                                                          out IntPtr ret);
        ...
        [DllImport(NativeLibrary, CallingConvention = CallingConvention)]
        public static extern ErrorType svm_c_trainer_set_cache_size_double(SvmKernelType kernelType,
                                                                           MatrixElementType type,
                                                                           IntPtr trainer,
                                                                           int cache_size);

        [DllImport(NativeLibrary, CallingConvention = CallingConvention)]
        public static extern ErrorType svm_c_trainer_get_cache_size_double(SvmKernelType kernelType,
                                                                           MatrixElementType type,
                                                                           IntPtr trainer,
                                                                           out int cache_size);

        [DllImport(NativeLibrary, CallingConvention = CallingConvention)]
        public static extern ErrorType svm_c_trainer_train_double(SvmKernelType kernelType,
                                                                  MatrixElementType type,
                                                                  IntPtr trainer,
                                                                  IntPtr x,
                                                                  IntPtr y,
        ...
        [DllImport(NativeLibrary, CallingConvention = CallingConvention)]
        public static extern ErrorType svm_c_trainer_train_float(SvmKernelType kernelType,
                                                                 MatrixElementType type,
                                                                 IntPtr trainer,
                                                                 IntPtr x,
                                                                 IntPtr y,
