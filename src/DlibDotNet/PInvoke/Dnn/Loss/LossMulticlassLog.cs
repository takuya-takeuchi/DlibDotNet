...
namespace DlibDotNet
{
    ...
    internal sealed partial class NativeMethods
    {
        ...
        [DllImport(NativeDnnLibrary, CallingConvention = CallingConvention)]
        public static extern ErrorType LossMulticlassLog_serialize_proxy(int id,
                                                                         IntPtr proxy,
                                                                         IntPtr obj,
                                                                         out IntPtr error_message);
        ...
        [DllImport(NativeDnnLibrary, CallingConvention = CallingConvention)]
        public static extern ErrorType LossMulticlassLog_net_to_xml(int id, IntPtr obj, byte[] filename, int filenameLength);

        [DllImport(NativeDnnLibrary, CallingConvention = CallingConvention)]
        public static extern ErrorType LossMulticlassLog_operator_left_shift(int id, IntPtr obj, IntPtr stream);
        ...
        [DllImport(NativeDnnLibrary, CallingConvention = CallingConvention)]
        public static extern IntPtr LossMulticlassLog_trainer_new2(int id, IntPtr net, int optimizer_id, IntPtr optimizer);

        [DllImport(NativeDnnLibrary, CallingConvention = CallingConvention)]
        public static extern void LossMulticlassLog_trainer_delete(int id, IntPtr trainer, int optimizer_id);

        [DllImport(NativeDnnLibrary, CallingConvention = CallingConvention)]
        public static extern ErrorType LossMulticlassLog_trainer_set_learning_rate(int id, IntPtr trainer, int optimizer_id, double lr);

        [DllImport(NativeDnnLibrary, CallingConvention = CallingConvention)]
        public static extern ErrorType LossMulticlassLog_trainer_get_learning_rate(int id, IntPtr trainer, int optimizer_id, out double lr);

        [DllImport(NativeDnnLibrary, CallingConvention = CallingConvention)]
        public static extern ErrorType LossMulticlassLog_trainer_get_average_loss(int id, IntPtr trainer, int optimizer_id, out double loss);

        [DllImport(NativeDnnLibrary, CallingConvention = CallingConvention)]
        public static extern ErrorType LossMulticlassLog_trainer_get_average_test_loss(int id, IntPtr trainer, int optimizer_id, out double loss);

        [DllImport(NativeDnnLibrary, CallingConvention = CallingConvention)]
        public static extern ErrorType LossMulticlassLog_trainer_set_min_learning_rate(int id, IntPtr trainer, int optimizer_id, double lr);

        [DllImport(NativeDnnLibrary, CallingConvention = CallingConvention)]
        public static extern ErrorType LossMulticlassLog_trainer_set_mini_batch_size(int id, IntPtr trainer, int optimizer_id, uint size);

        [DllImport(NativeDnnLibrary, CallingConvention = CallingConvention)]
        public static extern ErrorType LossMulticlassLog_trainer_be_verbose(int id, IntPtr trainer, int optimizer_id);
