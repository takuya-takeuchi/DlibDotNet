...
namespace DlibDotNet
{
    ...
    internal sealed partial class NativeMethods
    {
        ...
        [DllImport(NativeDnnLibrary, CallingConvention = CallingConvention)]
        public static extern ErrorType loss_mmod_deserialize(byte[] fileName,
                                                             int type,
                                                             out IntPtr net,
                                                             out IntPtr errorMessage);

        [DllImport(NativeDnnLibrary, CallingConvention = CallingConvention)]
        public static extern ErrorType loss_mmod_deserialize_proxy(IntPtr proxy_deserialize, 
                                                                   int type, 
                                                                   out IntPtr net,
                                                                   out IntPtr errorMessage);

        [DllImport(NativeDnnLibrary, CallingConvention = CallingConvention)]
        public static extern ErrorType loss_mmod_serialize(IntPtr obj, int type, byte[] fileName, out IntPtr errorMessage);

        [DllImport(NativeDnnLibrary, CallingConvention = CallingConvention)]
        public static extern void loss_mmod_input_tensor_to_output_tensor(IntPtr net, int networkType, IntPtr p, out IntPtr ret);

        [DllImport(NativeDnnLibrary, CallingConvention = CallingConvention)]
        public static extern void loss_mmod_net_to_xml(IntPtr net, int networkType, byte[] fileName);
