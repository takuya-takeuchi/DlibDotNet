...
namespace DlibDotNet
{
    ...
    internal sealed partial class NativeMethods
    {
        ...
        public static extern IntPtr queue_kernel_1a_int32_t_new();

        [DllImport(NativeLibrary, CallingConvention = CallingConvention)]
        public static extern void queue_kernel_1a_int32_t_delete(IntPtr q);

        [DllImport(NativeLibrary, CallingConvention = CallingConvention)]
        public static extern void queue_kernel_1a_int32_t_clear(IntPtr q);

        [DllImport(NativeLibrary, CallingConvention = CallingConvention)]
        public static extern void queue_kernel_1a_int32_t_reset(IntPtr q);

        [DllImport(NativeLibrary, CallingConvention = CallingConvention)]
        [return: MarshalAs(UnmanagedType.U1)]
        public static extern bool queue_kernel_1a_int32_t_move_next(IntPtr q);

        [DllImport(NativeLibrary, CallingConvention = CallingConvention)]
        public static extern int queue_kernel_1a_int32_t_size(IntPtr q);

        [DllImport(NativeLibrary, CallingConvention = CallingConvention)]
        public static extern void queue_kernel_1a_int32_t_enqueue(IntPtr q, int e);

        [DllImport(NativeLibrary, CallingConvention = CallingConvention)]
        public static extern void queue_kernel_1a_int32_t_dequeue(IntPtr q, out int e);

        [DllImport(NativeLibrary, CallingConvention = CallingConvention)]
        public static extern int queue_kernel_1a_int32_t_element(IntPtr q);
