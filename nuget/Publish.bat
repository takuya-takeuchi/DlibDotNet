...
dotnet nuget push DlibDotNet.CUDA92.%1.nupkg -k %2 -s https://api.nuget.org/v3/index.json
dotnet nuget push DlibDotNet.UWP.%1.nupkg -k %2 -s https://api.nuget.org/v3/index.json
dotnet nuget push DlibDotNet.%1.nupkg -k %2 -s https://api.nuget.org/v3/index.json