...
$BuildTargets = @()
$BuildTargets += [BuildTarget]::new("desktop", "cpu",  64, "/x64",   "$OperatingSystem-x64", 0   )
# $BuildTargets += [BuildTarget]::new("desktop", "cpu",  32, "/x86",   "$OperatingSystem-x86", 0   )
$BuildTargets += [BuildTarget]::new("desktop", "mkl",  64, "/x64",   "$OperatingSystem-x64", 0   )
# $BuildTargets += [BuildTarget]::new("desktop", "mkl",  32, "/x86",   "$OperatingSystem-x86", 0   )
...
$BuildTargets += [BuildTarget]::new("desktop", "arm",  64, "/arm64", "$OperatingSystem-arm64", 0   )
